        ...
        <div>
            <div css={s.searchBar}>
                ...
                <Select 
                    ...
                    defaultValue={selectedCaterogy.defaultValue} 
                    value={selectedCaterogy.option}
                    onChange={selectedCaterogy.handleOnChange}
                />
                <Select 
                    styles={selectStyle} 
